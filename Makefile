...
trafficcop_LOCAL_HOST?=0.0.0.0
trafficcop_LOCAL_PORT?=8080
trafficcop_LOG_LEVEL?=0
...
run: build
	...
	@docker run --name ${CONTAINER_NAME} \
		-e "trafficcop_LOCAL_HOST=${K8SAPP_LOCAL_HOST}" \
		-e "trafficcop_LOCAL_PORT=${K8SAPP_LOCAL_PORT}" \
		-e "trafficcop_LOG_LEVEL=${K8SAPP_LOG_LEVEL}" \
