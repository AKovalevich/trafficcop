...
type Server struct {
	mainConfiguration *config.TrafficcopConfiguration
...
// Create new trafficcop server
func NewServer(config *config.TrafficcopConfiguration) Server {
	var server Server
	...
	// Configure main trafficcop HTTP server
